...
/* Conversation font size, user-adjustable (A−/A+ control); the file tree,
   ...
   the system text scale untouched. */
[data-conversation-scroll] { font-size: var(--dsh-chat-font-size, 16px); }
[data-conversation-scroll] * { font-size: var(--dsh-chat-font-size, 16px) !important; }
.dsh-layout-fontctl {
...
.dsh-layout-fontbtn {
  ...
  color: var(--dsw-alias-label-primary); cursor: pointer; font-size: 13px;
}
.dsh-layout-fontbtn:hover { background: var(--dsw-alias-interactive-bg-hover); }
.dsh-layout-fontval { font-size: 12px; color: var(--dsw-alias-label-secondary); min-width: 22px; text-align: center; }
