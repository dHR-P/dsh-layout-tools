...
`;
		...
		function apply(ctx) {
			...
			// The layout settings card inside Settings → plugin configuration
			// (official settings.plugin.item list slot; root scope — no session
			// dependency, so register at the plugin level, not in the session
			// scope below).
